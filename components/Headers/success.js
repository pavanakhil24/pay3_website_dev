...
function Deposit() {
  ...
  return (
    ...
    {/* <div> */}
        ...
        {/* </div> */}
    <div >
      <span style={{fontSize:'20px',fontWeight:'bold',color:'black',marginLeft:'30px'}}>2 Transactions completed successfully </span>
      <br></br>
    <span style={{fontSize:'24px',fontWeight:'bold',color:'green',padding:'10px',marginLeft:'120px'}}>Payment Success</span>
    <br></br>
