                  ...
                  <CardBody>
                    <Row>
                      <div className="col">
                        ...
                        <span style={{color:'black',fontWeight:'normal',marginLeft:'5px'}}>ETH 0.0000</span>
                      </span>
                      </div>
                    </Row>
                  </CardBody>
                  ...
                  <CardBody style={{borderRadius:'10px'}}>
                    <Row>
                      <div className="col">
                        ...
                        <Button style={{borderRadius:'10px',width:'190px',fontSize:'18px',backgroundColor:'#e67516',color:'white'}} onClick={toggle} >WITHDRAW</Button>
